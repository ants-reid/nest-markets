...
| QA-016 | Cockpit and monitor build | cockpit, audit, and monitor pages compile in the production Next build | automated | passing | WEB-PX07, WEB-PX08, WEB-PX09, WEB-PX09A, WEB-PX09B, WEB-PX09C, WEB-PX09D, WEB-PX09E, WEB-PX10, WEB-PX11, WEB-PX12, WEB-PX13, WEB-PX14, WEB-PX15, WEB-PX16, WEB-PX17, WEB-PX25, WEB-PX26, WEB-PX31 | `cd apps/web && npm run lint && npm run build` remained green on 2026-05-22 while adding the MH-COCKPIT-10 `/cockpit/alerts-needing-attention` surface. |
