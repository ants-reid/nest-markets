...
| QA-016 | Cockpit and monitor build | cockpit, audit, and monitor pages compile in the production Next build | automated | passing | WEB-PX07, WEB-PX08, WEB-PX09, WEB-PX10, WEB-PX11, WEB-PX12, WEB-PX13, WEB-PX14, WEB-PX15, WEB-PX16, WEB-PX17, WEB-PX25, WEB-PX26, WEB-PX31 | `cd apps/web && npm run build` passed on 2026-05-19, including the new `/monitor/feeds` route during MH-FEED-MONITOR-001 |
