...
from app.api.routes.cockpit_alerts_needing_attention import router as cockpit_alerts_needing_attention_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(cockpit_alerts_needing_attention_router)
