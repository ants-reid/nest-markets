...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"AUTO_PAPER_MAX_ORDERS_PER_RUN": "4"},
        {"AUTO_PAPER_MAX_ORDERS_PER_DAY": "26"},
        {"AUTO_PAPER_MAX_ORDERS_PER_RUN": "0"},
        {"AUTO_PAPER_MAX_ORDERS_PER_DAY": "0"},
        {"AUTO_PAPER_MAX_NOTIONAL_USD": "1001"},
    ...
    ids=[
        ...
        "MAX_ORDERS_PER_RUN_above_three",
        "MAX_ORDERS_PER_DAY_above_twenty_five",
