...
const ROUTES: { id: string; path: string; heading: RegExp | string }[] = [
  ...
  { id: "QA-R18C2", path: "/cockpit/manual-paper-submit-confirmation", heading: /manual ibkr paper submit confirmation/i },
  { id: "QA-R18C3", path: "/cockpit/audit/broker-submit-decisions", heading: /broker submit decision timeline/i },
